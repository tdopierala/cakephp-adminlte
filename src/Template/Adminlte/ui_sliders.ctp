<?php
	...
	$this->Html->css('/vendor/almasaeed2010/adminlte/plugins/bootstrap-slider/slider.css', ['block' => true]);

	$this->Html->script('/vendor/almasaeed2010/adminlte/plugins/bootstrap-slider/bootstrap-slider.js', ['block' => 'scriptBottom']);
	$this->Html->script('/js/demo.sliders.js', ['block' => 'scriptBottom']);
