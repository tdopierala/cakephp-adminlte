<?php
    ...
    $this->Html->script('/vendor/almasaeed2010/adminlte/bower_components/jquery-knob/js/jquery.knob.js', ['block' => 'scriptBottom']);
    ...
    $this->Html->script('/js/demo.inline.js', ['block' => 'scriptBottom']);
